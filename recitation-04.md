...
**Parallelizing this solution is challenging because when multiple processes update the same work in the shared dictionary at the same time, it can lead to conflicts or incorrect results.**
